          ...
          <ul className="nav nav-tabs card-header-tabs">
            <li className="nav-item">
              ...
              <p>
                ...
                integrating advanced features, our app is designed to enhance
                your healthcare experience, providing a user-friendly platform
                that puts your well-being at the forefront.
              </p>
            </li>
          </ul>
        </div>
